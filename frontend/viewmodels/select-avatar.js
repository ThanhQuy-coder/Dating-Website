...
const avatars = {
  boy: [
    "assets/images/select-avt/boy1.png",
    "assets/images/select-avt/boy2.png",
    "assets/images/select-avt/boy3.png",
    "assets/images/select-avt/boy4.png",
    "assets/images/select-avt/boy5.png",
    "assets/images/select-avt/boy6.png",
  ],
  girl: [
    "assets/images/select-avt/girl1.png",
    "assets/images/select-avt/girl2.png",
    "assets/images/select-avt/girl3.png",
    "assets/images/select-avt/girl4.png",
    "assets/images/select-avt/girl5.png",
    "assets/images/select-avt/girl6.png",
  ],
  animals: [
    "assets/images/select-avt/animal1.png",
    "assets/images/select-avt/animal2.png",
    "assets/images/select-avt/animal3.png",
    "assets/images/select-avt/animal4.png",
    "assets/images/select-avt/animal5.png",
    "assets/images/select-avt/animal6.png",
  ],
};
...
bgGradient.style.background =
  "linear-gradient(120deg, #ffe6f2 0%, #fcb7d4 50%, #f7c6e0 100%)";
...
const bokehColors = [
  "rgba(252,183,212,0.18)",
  "rgba(255,230,242,0.16)",
  "rgba(247,198,224,0.15)",
  "rgba(243,89,128,0.13)",
  "rgba(179,136,255,0.13)",
  "rgba(129,236,236,0.13)",
];
let bokehs = [];
